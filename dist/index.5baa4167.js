...
function initializeApp() {
    try {
        ...
        (0, _storageJs.initializeStorage)();
        (0, _tabsJs.initializeTabs)();
        // Load initial data
        loadTransactions();
...
function setupEventListeners() {
    ...
    if (transactionForm) transactionForm.addEventListener('submit', (e)=>{
        ...
        if (transaction.type === 'expense') transaction.amount = -Math.abs(transaction.amount);
        try {
    ...
    document.addEventListener('click', (e)=>{
        if (e.target.matches('.delete-btn')) {
            ...
            if (id) try {
                (0, _storageJs.deleteTransaction)(id);
                loadTransactions();
            } catch (error) {
...
},{"./storage.js":"kS9sU","./tabs.js":"eS7re"}],"kS9sU":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "getTransactions", ()=>getTransactions);
parcelHelpers.export(exports, "saveTransaction", ()=>saveTransaction);
parcelHelpers.export(exports, "deleteTransaction", ()=>deleteTransaction);
parcelHelpers.export(exports, "getGoals", ()=>getGoals);
parcelHelpers.export(exports, "saveGoal", ()=>saveGoal);
...
function initializeStorage() {
    ...
    if (!localStorage.getItem('goals')) localStorage.setItem('goals', JSON.stringify([]));
    return true;
}
...
function initializeAnalytics() {
    ...
    if (expenseCtx) {
        ...
        new (0, _autoDefault.default)(expenseCtx, {
            type: 'pie',
            data: {
    ...
    if (trendCtx) {
        ...
        new (0, _autoDefault.default)(trendCtx, {
            type: 'line',
            data: {
...
function initializeGoals() {
    ...
    if (!goalsGrid) return;
    const goals = (0, _storageJs.getGoals)();
    goalsGrid.innerHTML = '';
    if (goals.length === 0) {
...
},{"chart.js/auto":"d8NN9","./storage.js":"kS9sU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["daR04","igcvL"], "igcvL", "parcelRequire94c2")
